...
function dump_table(o, depth)
    ...
    local ignore_keys = {
        -- by putting a key name here that appears in slot_data you can hide it from the printout,
        -- which is useful for keys with LOTS of data that will make your debugging a level hell
        -- if 1000s lines are printed on every connect. Thanks Pokemon tables.
