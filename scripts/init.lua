...
-- Locations
Tracker:AddLocations("locations/access.jsonc") -- all our location-based access logic goes in here
Tracker:AddLocations("locations/overworld.jsonc") -- the overworld map goes in here
Tracker:AddLocations("locations/submaps.jsonc") -- this entirely contains refs to the overworld map for submaps.
